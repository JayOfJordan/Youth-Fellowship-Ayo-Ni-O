                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('401 C.M. (FE424)', // Updated Title
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("1.f	    Ẹmi Mimọ , mi s'ọkan wa,\n" // Updated verse
                        "K'a mọ agbara Rẹ,\n"
                        "Orisun emi 'sọtẹlẹ,\n"
                        "T'imọlẹ at'ifẹ.",
                      style: TextStyle(color: Colors.black,
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.f	    Ẹmi Mimọ, l'agbara Rẹ,    \n" // Updated verse
                        "L'awọn woli sise;\n"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.f	    Adaba ọrun, na 'yẹ Rẹ,     \n" // Updated verse
                        "Bọ okun ẹda wa;\n"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("4.f	    A o mo Ọlọrun daju,         \n" // Updated verse
