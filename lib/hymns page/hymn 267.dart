                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('267  C.M.S. 569  O.C.H.C. 154   C.M.     (FE 287)',
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("1.mf	    Isẹ gbogbo ti awa n se,            "
                        "\nNi Ọlọrun ti ri;"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.mp	    A ko le f'ẹsẹ wa pamọ,            "
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.		    Ohun gbogbo han ni gbangban, "
                        "\nNi oju Ọlọrun;"
                        "\nOkunkun ati imọlẹ,"
                        "\nSi ri bakan naa fun.",
                      style: TextStyle(color: Colors.black,
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("4.ff	    Ọlọrun, jẹ k'a ranti pe,               "
                        "\nOju rẹ si ri wa;"
