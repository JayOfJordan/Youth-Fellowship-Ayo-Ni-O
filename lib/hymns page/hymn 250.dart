                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('250  C.M.S. 155  H.C. 148  S.M. (FE 270)',
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("1.p	    JESU jọ ranti mi,            "
                        "\nK'O si w'ẹsẹ mi nu;"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.p	    Jesu, jọ ranti mi,"
                        "\nEm' ẹni 'nilara;"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.mf	    Jesu, jọ ranti mi,         "
                        "\nMase jẹ ki n sako;"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("4.p	    Jesu, jọ ranti mi,           "
                        "\nGba gbogbo rẹ kọja,"
