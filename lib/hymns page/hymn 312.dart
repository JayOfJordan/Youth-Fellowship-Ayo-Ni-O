                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('312	  A. & M. 125 8s.  (FE 332)',
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("1.p	    LẸBA iboji Jesu mi,       "
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.p	    Ara arẹ jaja sinmi,         "
                        "\nIrora ati wahala,"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.		      Iho t'a wọ n'nu okuta,    "
                        "\nNitẹ Olugbala si;"
                        "\nỌlọrun, Ẹlẹda ayé.",
                      style: TextStyle(color: Colors.black,
                          fontWeight: FontWeight.normal,
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("4.		      Ẹyin t'ọfọ sẹ, t'ẹ n daro,"
