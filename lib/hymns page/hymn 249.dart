                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('249 C.M.S. 154  H.C. 323,  C.M (FE 269)',
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("1.mf	    A F'AYỌ r'ore-ọfẹ         "
                        "\nT' Alufa giga wa,"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.		    Tinutinu l'o n daro wa,   "
                        "\np	    O mọ ailera wa;"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.		    Oun papa l'ọjọ aye Rẹ,   "
                        "\np	    O sọkun kikoro;"
                        "\nO mba olukuluku pin,"
                        "\nNinu iya ti n jẹ.",
                      style: TextStyle(color: Colors.black,
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("4.pp	    Je ki a f'igbagbọ 'rẹlẹ,"
                        "\nW'anu at'ipa Rẹ,"
                        "\nAwa o si ri igbala,"
                        "\nL'akoko iyọnu.",
                      style: TextStyle(color: Colors.black,
