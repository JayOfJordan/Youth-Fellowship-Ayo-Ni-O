                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('450 C.M.S. 320 H.C. 290 (FE 475)', // Corrected Title
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("1.f	    'GBA mo le ka oye mi re,\n"
                        "Ni ibugbe l'oke;\n"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.		    B'ayé kọju ’ja s'ọkan mi,\n"
                        "T'a ń sọ oko si i;\n"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.		    K'aniyan de b'ikun omi,\n"
                        "f	    K'iji banujẹ ja;\n"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("4.f	    Nibẹ lọkan mi y'o luwẹ,\n"
                        "N'nu okun isinmi;\n"
