                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('496 C.M.S. 584. t.H.C. 318. C.M (FE 522)', // Àkọlé Tó Tọ
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Text("1.	        ẸNI T'O la 'ju afọju,   \n"
                        "Ti O mu ope  gbọn,\n"
                        "At'ẹni t'O da imọlẹ,\n"
                        "Fun ẹni okunkun.",
                      style: TextStyle(color: Colors.black,
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.fromLTRB(15.0, 0, 15.0, 15.0),
                    child: Text("2.	    Ẹni t'O le fi agbara,       \n"
                        "F'awọn olokunrun,\n"
                        "Ti O si fi ẹmi iye,\n"
                        "Fun awọn t'o ti ku.",
                      style: TextStyle(color: Colors.black,
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.fromLTRB(15.0, 0, 15.0, 15.0),
                    child: Text("3.	    Ẹni fi 'dasilẹ f'ọkan,       \n"
                        "T'O gb'ẹni subu nde,\n"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.fromLTRB(15.0, 0, 15.0, 15.0),
                    child: Text("4.	    'Wọ Onisegun ọkan mi,\n"
                        "Si Ọ l'awa n kọrin,\n"
