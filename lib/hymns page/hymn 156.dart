                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('156    C.M.S. 278  A&M 613\n'
                                '8.8.6.     (FE 175)',
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("1.mf	    SI Ọ Olutunu ọrun,         "
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.		    Si Ọ, ifẹ ẹni t'o wa,             "
                        "\nNinu Majẹmu Ọlọrun,"
                        "\nA ń kọ Alleluya.",
                      style: TextStyle(color: Colors.black,
                          fontWeight: FontWeight.normal,
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.mf	    Si Ọ ohun ẹni ti ń pe,    "
                        "\nAsako kuro ninu ẹsẹ,"
                        "\nf	    A ń kọ Alleluya.",
                      style: TextStyle(color: Colors.black,
                          fontWeight: FontWeight.normal,
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("4.		    Si Ọ, agbara ẹni ti,            "
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("5.mf	    Si Ọ ododo Ẹni ti,         "
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("6.		    Si Ọ, Olukọ at'Ọrẹ,           "
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("7.mf	    Si Ọ, Ẹni ti Kristi ran,"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("8.f	    Si Ọ, Ẹni t'o jẹ ọkan,        "
                        "\nPẹlu Baba ati Ọmọ,"
                        "\nff	    A ń kọ Alleluya.",
                      style: TextStyle(color: Colors.black,
                          fontWeight: FontWeight.normal,
