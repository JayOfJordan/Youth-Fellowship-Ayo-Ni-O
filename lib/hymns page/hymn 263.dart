                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('263  C.M.S. 189   H.C. 171   8s.   6s.  4       (FE 283)',
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("1.mp	    Pada asako, s'ile rẹ,"
                        "\nBaba rẹ l'o n pe ọ;"
                        "\nMase alarinkiri mọ,"
                        "\nNin' ẹsẹ at'osi;"
                        "\npp		    Pada, pada.",
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.mp	    Pada asako s'ile rẹ,"
                        "\nJesu l'o sa n pe ọ;"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.mp	    Pada asako s'ile rẹ,"
