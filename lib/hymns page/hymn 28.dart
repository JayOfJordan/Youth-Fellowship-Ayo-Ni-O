            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.		Jẹ ka wa Ọ, ka ri Ọ "
                        "\nNi Ọlọrun Kérúbù;"
                        "\nKo ran ifẹ rere Rẹ"
                        "\nSarin Ẹgbẹ Séráfù.",
                      style: TextStyle(color: Colors.black,
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.Mu ki gbogbo agbayé,"
                        "\nTẹti sọrọ mimọ Rẹ,"
                        "\nM'alagidi tẹriba,"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("4.		Ẹni n wa Ọ ko ri Ọ, "
                        "\nẸni n subu gbe dide;"
                        "\nW'alaisan, at'afọju,"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("5.		Bukun ọrọ mimọ Rẹ, "
                        "\nTo ran wa lakoko yi;"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("6.		Ogo ni fun Baba wa, "
                        "\nOgo ni fun Ọmọ Rẹ,"
                        "\nOgo ni f'Ẹmi Mimọ"
                        "\nOgo fun Mẹtalọkan.",
                      style: TextStyle(color: Colors.black,
