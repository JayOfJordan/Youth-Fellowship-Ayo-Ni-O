                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('396 C.M.S. 289 H.C. 487. 7s. (FE 419)', // Updated Title
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("1.mf	    BIBELI mimọ t'ọrun,         \n" // Updated verse
                        "Ọwọn isura t'emi!\n"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.p	    'Wọ n kọ mi, bi mo sina,    \n" // Updated verse
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.f	    'Wọ n'ima tu wa ninu,        \n" // Updated verse
                        "Ninu wahala ayé,\n"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("4.	    'Wọ l'o n sọ t'ayọ ti mbọ,    \n" // Updated verse
                        "At'iparun ẹlẹsẹ;\n"
                        "Bibeli mimọ t'ọrun,\n"
                        "Ọwọn isura t'emi.",
                      style: TextStyle(color: Colors.black,
