                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('430 C.M.S. 547 t.H.C. 229 C.M. (FE 453)', // Updated Title
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("1.mf	    ỌLỌRUN, a sọ ọrọ Rẹ,\n" // Updated verse
                        "Bi 'rugbin l'or'ilẹ;\n"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.		    K'ọta Kristi oun eniyan, \n" // Updated verse
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.cr	    Ma jẹ ki aniyan ayé,    \n" // Updated verse
                        "Bi ọrọ oun ayọ,\n"
                        "Tabi ijọna, oun iji,\n"
                        "Run irugbin ọrun.",
                      style: TextStyle(color: Colors.black,
