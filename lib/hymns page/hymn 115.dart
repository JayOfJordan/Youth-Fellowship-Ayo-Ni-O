                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('115   C.M.S. 556   H.C. 564\n'
                                'C.M.      (FE 132)',
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("1.		FUN anu to pọ b'iyanrin,"
                        "\nTi mo n gba l'ojumọ;"
                        "\nLat'ọdọ Jesu Oluwa,"
                        "\nKi l'emi o fi fun?",
                      style: TextStyle(color: Colors.black,
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.p	    Kini n ó fi fun Oluwa,"
                        "\nLat' inu ọkan mi?"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.cr	    Eyi l'ohun t'emi o se,"
                        "\nF'ohun to se fun mi,"
                        "\nEm'o mu ago igbala,"
                        "\nN ó ke pe Ọlọrun.",
                      style: TextStyle(color: Colors.black,
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("4.mp	    Eyi l'ọpẹ ti mo le da,"
                        "\nEmi osi, are:"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("5.		Emi ko le sin b'o ti to,"
