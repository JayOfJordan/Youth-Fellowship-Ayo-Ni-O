                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('282	     BAP/HY50          (FE 302)',
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("1.mf	    IFẸ l'Ọlọrun, anu Rẹ,     "
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.p	    Iku n doro pupọpupọ,     "
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.		      Lakoko t'o dab'o sokun,"
                        "\nA ń ri Ore Rẹ daju,"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("4.		      O sọ 'reti, at'itunu,          "
                        "\nMọ aniyan ayé wa,"
