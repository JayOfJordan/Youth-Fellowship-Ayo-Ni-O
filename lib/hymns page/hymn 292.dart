                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('292	   CMS 166  t.H.C. 233 C.M(FE 313)',
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("1.mf	    Krist' t'agbelegbu l'orin wa,"
                        "\nIjinlẹ t'awa n sọ;"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.		      Sugbọn ọkan t'Ọlọrun kọ,    "
                        "\nF'ayọ gba ọrọ naa;"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.f	    Adun, orukọ Rẹ yiye,             "
                        "\nMu 'sọji s'ọkan wọn,"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("4.		      Lai j'ọlọrun t'or'ọfẹ ka         "
                        "\nBi ọwara ojo;"
