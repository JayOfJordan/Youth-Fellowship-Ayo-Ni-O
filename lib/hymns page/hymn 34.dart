                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('34  C.M.S. 28 o.t. H.C. 167 S.M.(FE 51)',
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.		O kọ wa pe Kristi"
                        "\nf	    Jinde ninu oku,"
                        "\nGbogbo ọsẹ a ma wi pé,"
                        "\nIwọ o ti pẹ to?",
                      style: TextStyle(color: Colors.black,
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("4.mf	    Iwọ sọ t'isinmi     "
                        "\nT'ilu alafia,"
