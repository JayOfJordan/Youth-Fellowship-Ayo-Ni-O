                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('562 C.M.S. 362 H.C. 361 (FE 589)',
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Text('''1.mf	    LARIN ewu at'osi,      
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.fromLTRB(15.0, 0, 15.0, 15.0),
                    child: Text('''2.f	    Kristian, ma tẹsiwaju,   
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.fromLTRB(15.0, 0, 15.0, 15.0),
                    child: Text('''3.f	    Jẹ ki ọkan yin k'o yọ:
Mu 'hamọra ọrun wọ:
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.fromLTRB(15.0, 0, 15.0, 15.0),
                    child: Text('''4.mp	    Ma jẹ k'inu yin bajẹ,  
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.fromLTRB(15.0, 0, 15.0, 15.0),
                    child: Text('''5.mf	    Njẹ ẹ ma tẹsiwaju,     
cr	    Ẹ o ju Asẹgun lọ,
