            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("1.mf	    ỌDUN titun de awa ń yọ,"
                        "\nAwa ijọ Séráfù,"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.ff	    Ayọ ọdun titun yipo,          "
                        "\nJ'ọdun t'o kọja lọ,"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.f	    Ọlọrun fun wa ni isẹgun,    "
                        "\nAwọn Angẹl  ń yọ,"
                        "\nKérúbù, Séráfù, ẹ yọ,"
                        "\nẸ ke Halleluyah (5 times)",
                      style: TextStyle(color: Colors.black,
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("4.f	    Ọjọ 'wasu adura Mose,       "
                        "\nT'Ọlọrun s'ami si,"
                        "\nA dupẹ lọw'Ọba Ogo"
                        "\nẸ ke Halleluyah (5 times)",
                      style: TextStyle(color: Colors.black,
