                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: ListTile(
                            title: Text('284	  C.M.S. 184 K. 151  t.H.C. 147 C.M.  (FE 305)',
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("1.mf	    JESU, l'ara Rẹ l'awa ń wo"
                        "\nẸgbẹgbẹrun ogo;"
                        "\nJu t'okuta iyebiye,"
                        "\nT'agbada Aaroni.",
                      style: TextStyle(color: Colors.black,
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("2.		      Wọn ko le sai ko rubọ na, "
                        "\nFun ẹsẹ ara wọn,"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("3.		      Jesu Ọba ogo gunwa,       "
                        "\nL'oke Sion t'ọrun;"
            ...
            Center(
              child: Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.all(15.0),
                    child: Text("4.		      Alagbawi lọdọ Baba,        "
                        "\nTi y'o wa titi lai;"
